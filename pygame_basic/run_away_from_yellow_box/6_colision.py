...
# 캐릭터(스프라이트) 불러오기
character = pygame.image.load('C:/Users/종환PC/Desktop/pygame_basic/character.png')
...
# 적 enemy 캐릭터
enemy = pygame.image.load('C:/Users/종환PC/Desktop/pygame_basic/enemy.png')
...
while running:
    dt = clock.tick(1000) # 게임화면의 초당 프레임 수를 설정
